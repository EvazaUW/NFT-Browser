...
// place holder, like plab B, if the image is damaged, then show this image
// why use the local picture? Loading faster. Can also put a URL, which is smaller in coding size but loading slower and has chance to break.
